...
const Hero = () => {
  ...
  const handleDownload = () => {
    ...
    const pdfPath = "/assets/img/cv/cv.pdf";
  ...
  return (
    <section className="bg-hero bg-cover bg-center min-h-[40vh] lg:h-[948px] bg-no-repeat relative mt-[120px] lg:mt-[150px]" id="hero">
      <div className="container mx-auto min-h-[40vh] lg:h-full flex items-center justify-center xl:justify-end">
        <div className="text-white text-center lg:text-left lg:max-w-[640px]">
          ...
          <div>
            <button className="btn btn-sm lg:btn-lg btn-outline mx-auto lg:mx-0" onClick={handleDownload}>
              {btnText}
